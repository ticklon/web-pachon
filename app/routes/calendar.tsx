...
export default function CalendarPage() {
  ...
  const specialDays = [
    { date: `${year}-${String(month).padStart(2, '0')}-15`, type: 'dinner-only' as const, description: 'Dinner only' },
    { date: `${year}-${String(month).padStart(2, '0')}-29`, type: 'dinner-only' as const, description: 'Dinner only' },
